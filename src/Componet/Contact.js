...
const Contact = () => {
  ...
  return (
    <div className='h-full w-full  flex flex-col items-center font-poppins  z-1' id='Contact' >
    ...
    <div className=' w-full laptop:w-[80%] laptop:ml-20 h-full  flex  justify-between items-center flex-col z-2 text-center laptop:text-left'>
     ...
     <div><div className='dark:text-white text-dark font-semibold tablet:text-5xl text-3xl'>Con<span className='text-green dark:text-lightgreen '>ta</span>c<span className='text-green dark:text-lightgreen '>t</span></div></div></div>
      ...
      <div className='w-full h-full flex-1 flex flex-col justify-around text-dark dark:text-white text-lg'>
          <div className='h-full flex items-center justify-center  laptop:justify-start text-xs tablet:text-base desktop:text-lg'>
    ...
    <div className='w-full h-40  bg-dark dark:bg-cold'  >
